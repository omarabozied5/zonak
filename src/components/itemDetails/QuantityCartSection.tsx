    ...
    <div className="space-y-4">
      ...
      <div className="space-y-2">
        ...
        <div className="flex items-center justify-between text-lg font-semibold border-t border-gray-200 pt-2">
          <span className="text-[#FBD252]">{totalPrice.toFixed(2)} ر.س</span>
      ...
      <div className="flex items-center gap-4">
        ...
        <Button
          ...
          className="flex-1 bg-[#FBD252] hover:bg-[#fcd358] text-white font-bold py-4 rounded-2xl disabled:opacity-50 disabled:cursor-not-allowed transition-all text-base"
        >

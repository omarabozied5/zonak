    ...
    <div className="space-y-3">
      ...
      <div className="relative">
        <textarea
          ...
          className="w-full resize-none border-2 border-gray-200 focus:border-yellow-400 focus:ring-2 focus:ring-yellow-400/20 text-sm text-right min-h-[80px] rounded-xl placeholder:text-right placeholder:text-gray-400 bg-white p-4"
          rows={3}
          dir="rtl"
        />
      </div>
